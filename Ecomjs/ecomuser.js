...
function displayUser(userdetails){
    ...
    userdetails.forEach(userdeet=>{
        ...
        row.innerHTML=`
            ...
            <td class="cart"><h4>${userdeet.address.city} ${userdeet.address.street} ${userdeet.address.number} ${userdeet.address.zipcode} ${userdeet.address.geolocation.long} ${userdeet.address.geolocation.lat}  </h4></td>
...
document.getElementById('add').addEventListener('click',()=>{
    ...
    function showuser(characters){
            ...
            <td class="cart"><h4>${characters.address.city} ${characters.address.street} ${characters.address.number} ${characters.address.zipcode} ${characters.address.geolocation.long} ${characters.address.geolocation.lat}  </h4></td>
