...
function displayProducts(characters){
    ...
    characters.forEach(character=>{
        ...
        row.innerHTML=`
            <td><img src="${character.image}"alt="${character.title}" width="30%"></td>
            <td><h4><a href="ecomproduct.html" onclick="show()" target="_blank">${character.title}</a></h4></td>
        ...
        function addNewProduct(newProduct){
            const tableBody = document.getElementById('body');
                ...
                row.innerHTML=`
                    ...
                    <td><h4><a href="ecomproduct.html" id="product-anchor" onclick="show()" target="_blank">${newProduct.title}</a></h4></td>
...
function sortProduct(products){
    ...
    row.innerHTML=`
            ...
            <td><h4><a href="ecomproduct.html" id="product-anchor"onclick="show()" target="_blank">${product.title}</a></h4></td>
